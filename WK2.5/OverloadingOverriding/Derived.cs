namespace OverrideOverload
{
    public class Derived : Base
    {
        ...
        //Method overriding is a technique that allows the invoking of function from another class
        ...
        public override void newMethod()     //"overrid" is REQUIRED to extend or modify the virtual implementation of an 
