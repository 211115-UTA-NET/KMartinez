...
//need to add a try catch to add an exception
app.Run(context =>
{
    //Exercise option 2
    ...
    //string filePath = System.IO.File.ReadAllText($"C:/Users/mkare_wyte20y/Revature/KarenM/WK5.5/.aspnetcoreExcersies/AspNetCoreExcersies/Excercise2.txt");
        ...
        context.Response.Body.Write(Encoding.UTF8.GetBytes($"path was: {path}, data is {filePath}, filename: {fileName}"));

    //Exercise option 1
    return Task.CompletedTask;
});

//not sure if its needed, but intellisense did this.
